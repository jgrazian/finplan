...
impl AccountsPanel {
    ...
    pub fn handle_key(key: AppKeyEvent, state: &mut AppState) -> EventResult {
    ...
    fn handle_accounts_keys(key: AppKeyEvent, state: &mut AppState) -> EventResult {
    ...
    fn handle_holdings_keys(key: AppKeyEvent, state: &mut AppState) -> EventResult {
